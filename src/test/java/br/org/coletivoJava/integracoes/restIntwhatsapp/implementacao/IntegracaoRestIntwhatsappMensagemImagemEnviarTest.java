...
public class IntegracaoRestIntwhatsappMensagemImagemEnviarTest {
    ...
    public void envioMensagemImagemTest() throws Exception {
        ...
        byte[] arquivo = UtilCRCBytes.gerarBytesPorArquivo(new File("/home/superBits/projetos/coletivoJava/source/integracao/intWhatsapp/src/test/resources/arquivos/teste.jpeg"));
