...
public class IntegracaoRestIntwhatsappMensagemPdfEnviarTest {
    ...
    public void envioMensagemPdfTest() throws Exception {
        ...
        byte[] arquivo = UtilSBCoreBytes.gerarBytesPorArquivo(new File("/home/superBits/projetos/coletivoJava/source/integracao/intWhatsapp/src/test/resources/arquivos/teste.pdf"));
