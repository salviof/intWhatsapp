 ...
 * @author salvio
 */
public class FabApiRestIntWhatsappMediaTest extends TestesApiRest {

    public FabApiRestIntWhatsappMediaTest() {
    }
    ...
    public void testValues() {
        try {
            ...
            gerarCodigosChamadasEndpoint(FabApiRestIntWhatsappMedia.class);
