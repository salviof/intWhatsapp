 ...
 * @author salvio
 */
public class FabApiRestIntWhatsappTemplateMensagemTest extends TestesApiRest {

    public FabApiRestIntWhatsappTemplateMensagemTest() {
    }
    ...
    public void testValues() {
        try {
            ...
            gerarCodigosChamadasEndpoint(FabApiRestIntWhatsappTemplate.class);
